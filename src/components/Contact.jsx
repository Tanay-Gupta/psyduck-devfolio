            ...
            <div className="max-w-3xl mx-auto bg-white/80 backdrop-blur-md p-8 md:p-12 rounded-xl shadow-lg border border-gray-200/50 text-center">
                ...
                <form onSubmit={handleSubmit}>
                    <div className="grid md:grid-cols-2 gap-6 mb-6">
                        <input type="text" name="name" className="w-full px-5 py-3 bg-gray-100 border-2 border-transparent rounded-lg focus:outline-none focus:border-[var(--primary-blue)] transition" placeholder="Your Name" />
                        <input type="email" name="email" className="w-full px-5 py-3 bg-gray-100 border-2 border-transparent rounded-lg focus:outline-none focus:border-[var(--primary-blue)] transition" placeholder="Your Email" />
                    </div>
                    <div className="mb-6">
                        <textarea name="message" rows="5" className="w-full px-5 py-3 bg-gray-100 border-2 border-transparent rounded-lg focus:outline-none focus:border-[var(--primary-blue)] transition" placeholder="Tell me about your project headache..."></textarea>
                    </div>
